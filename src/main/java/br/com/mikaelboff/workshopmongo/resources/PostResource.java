...
import br.com.mikaelboff.workshopmongo.resources.util.URL;
import br.com.mikaelboff.workshopmongo.services.PostService;
...
public class PostResource {
	...
	public ResponseEntity<List<Post>> findByTitulo(@RequestParam(value = "text", defaultValue = "") String text) {
		...
		return ResponseEntity.ok().body(service.findByTitulo(text));
	}
